...
class SimulaDispositivo:
    ...
    def gera_dispositivos_randomizados():
        #Gera IMEIS aleatórios de 8 dígitos
        IMEI = int(random.randint(10000000,99999999))

        #Geradatas aleatórias para fabricação, mensagem e erro
        ...
        #Insere mensagens no banco de dados
    ...
    def atualizar_maquinas(imei, mensagem_anterior):
        ...
        #Atualiza as mensagens de acordo com o tipo de mensagem anterior
    ...
    def inicia_simulacao_de_dispositivos():
        ...
        while True:
            #Retorna a lista de mensagens e embaralha ela para que a ordem de atualização seja aleatória e garanta que algumas máquinas não responderão
